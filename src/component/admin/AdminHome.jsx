...
const AdminHome = () => {
  ...
  useEffect(() => {
    // Fetch contact count
    axios
      .get("http://localhost:3400/admin/getTotalContactCount")
      .then((response) => {
    ...
    axios
      .get("http://localhost:3400/admin/getTotalFeedbackCount")
      .then((response) => {
    ...
    axios
      .get("http://localhost:3400/Customer/getUserCount")
      .then((response) => {
                ...
                <div className="row row-cols-1 row-cols-md-3 g-3">
                    <div className="col">
                        <div className="TRC rounded-3 p-3 text-center">
                            <h3 className="fs-5 font-weight-bold ">Total Ragistered Customer</h3>
